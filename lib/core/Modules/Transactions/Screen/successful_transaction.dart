...
class SuccessfulTransactionsScreen extends StatefulWidget {
  const SuccessfulTransactionsScreen({Key? key}) : super(key: key);

  @override
  _SuccessfulTransactionsScreenState createState() =>
      _SuccessfulTransactionsScreenState();
}

class _SuccessfulTransactionsScreenState
    extends State<SuccessfulTransactionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final apis = Apisaldo();
    final RegisterPasswordController contro = Get.put(RegisterPasswordController());
        ...
        child: Column(
          children: [
            Screenshot(
              ...
              child: Container
              (color: Colors.white,child: BasicSuccess(
                  title: "Pagamento Realizado",
                  value: purchase.saldo,
                  value2: controller.valor.text,
                  isTransaction: true,
                  pagadorName: purchase.nome,
                  pagadorCPF: purchase.cpf,
                  destinatarioName: "TNP Brasil",
                  destinatarioCPF: '34.519.401/0001-74',
