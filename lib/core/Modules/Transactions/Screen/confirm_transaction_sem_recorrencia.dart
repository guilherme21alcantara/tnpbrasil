...
class ConfirmTransactionDataScreenSemRecorrencia extends StatefulWidget {
  const ConfirmTransactionDataScreenSemRecorrencia({Key? key}) : super(key: key);

  @override
  _ConfirmTransactionDataScreenSemRecorrenciaState createState() =>
      _ConfirmTransactionDataScreenSemRecorrenciaState();
}

class _ConfirmTransactionDataScreenSemRecorrenciaState
    extends State<ConfirmTransactionDataScreenSemRecorrencia> {
  @override
    ...
    Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
              child: TransactionButtonSemRecorrencia(
            name: 'Transferir',
          ))
        ],
      ),
