...
class InsertTransactionValueScreen extends StatefulWidget {
  const InsertTransactionValueScreen({Key? key}) : super(key: key);
...
class _InsertTransactionValueScreenState
    extends State<InsertTransactionValueScreen> {
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
              child: AvancarButton(
            name: 'Avançar',
            goTo: Routes.confirmTransactionData,
