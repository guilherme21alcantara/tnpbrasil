...
class FourDigitsPasswordInput extends StatefulWidget {
  const FourDigitsPasswordInput({Key? key}) : super(key: key);

  @override
  _FourDigitsPasswordInputState createState() =>
      _FourDigitsPasswordInputState();
}

class _FourDigitsPasswordInputState extends State<FourDigitsPasswordInput> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(
                ...
                onPressed: () {
                  if (con.recorrencia != null) {
                    print("aaa");
                    Get.to(InsertTransactionValueScreen());
                  } else {
                    {
                      print("aassss");
                      Get.to(InsertTransactionValueSemRecorrenciaScreen());
                    }
