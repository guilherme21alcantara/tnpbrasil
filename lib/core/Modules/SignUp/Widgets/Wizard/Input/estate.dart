...
class InputEstateS extends GetView<SingupController> {
  InputEstateS({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    final api_city = ApiCity();
    final api_state = ApiEstate();
    final SingupController controllers = Get.put(SingupController());
