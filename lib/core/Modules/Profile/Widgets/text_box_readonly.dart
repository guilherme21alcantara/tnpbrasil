...
class TextBoxRead extends StatefulWidget {
  final String title;
  final String ? value;
  const TextBoxRead({Key? key, required this.title, required this.value})
      : super(key: key);

  @override
  _TextBoxReadState createState() => _TextBoxReadState();
}

class _TextBoxReadState extends State<TextBoxRead> {
  @override
