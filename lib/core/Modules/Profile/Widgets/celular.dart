...
class TextBoxTelefone extends StatefulWidget {
  final String title;
  final String value;
  const TextBoxTelefone({Key? key, required this.title, required this.value})
      : super(key: key);
...
class _TextBoxState extends State<TextBoxTelefone> {
  @override
