...
class TexBoxSenha extends StatefulWidget {
  final String title;
  final String value;
  const TexBoxSenha({Key? key, required this.title, required this.value})
      : super(key: key);
...
class _TextBoxState extends State<TexBoxSenha> {
  @override
